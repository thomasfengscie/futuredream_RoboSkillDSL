#!/usr/bin/env python3(english version in the back)
"""
...
#!/usr/bin/env python3
"""
RoboSkill DSL Compiler - RSL Compiler
=====================================
...
Options:
    ...
    -t, --target <platform> Target platform (python, cpp, ros, home_assistant)
    -I, --interpret         Run directly via interpreter
    -v, --verbose           Verbose output
    --ast                   Print AST (for debugging)

Examples:
    python rslc.py cleaning_robot.rsl -t python -o output.py
    python rslc.py skill.rsl -I  # Run directly
    python rslc.py skill.rsl -t cpp -o skill.cpp
"""
...
def compile_file(input_file: str, target: str, output_file: str = None, verbose: bool = False):
    """Compile RSL file to target language"""
    try:
        # Read source file
        with open(input_file, 'r', encoding='utf-8') as f:
            source = f.read()
...
def interpret_file(input_file: str, platform: str = "python", verbose: bool = False):
    """Interpret and execute RSL file directly"""
    try:
        # Read source file
        with open(input_file, 'r', encoding='utf-8') as f:
            source = f.read()
